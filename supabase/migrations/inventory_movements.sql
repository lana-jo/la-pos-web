...
-- 2. MODIFIKASI TABEL MASTER PRODUK & VARIAN
...
-- Inisialisasi cached_stock dari kolom lama (jika ada)
...
-- 3. MODIFIKASI TABEL LEGACY (stock_movements)
...
-- 4. PEMBUATAN TABEL BUKU BESAR (inventory_movements)
...
-- 5. FUNGSI DATABASE (Kalkulasi Atomik & Anti-Race Condition)
...
-- 7. PEMBUATAN INDEX UNTUK PERFORMA QUERY
